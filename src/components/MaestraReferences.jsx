      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <div className="prose prose-invert max-w-none text-white/90 mb-6">
            <p>
              Con más de <span className="text-gold font-semibold">20 años de experiencia</span> en amarres de amor y magia blanca ancestral,
              he dedicado mi vida a ayudar a miles de personas a recuperar el amor de su vida y encontrar la felicidad que merecen.
            </p>

            <p>
              Soy especialista reconocido en amarres de amor efectivos, retornos de pareja, endulzamientos y protección espiritual.
              Trabajo únicamente con magia blanca ancestral, respetando el libre albedrío y las leyes universales.
            </p>

            <p>
              He reunido a más de <span className="text-gold font-semibold">5,000 parejas</span> y fortalecido innumerables relaciones en
              México y otros países. Mi compromiso es brindarte resultados reales con ética y profesionalismo.
            </p>
          </div>
